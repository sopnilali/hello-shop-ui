        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm">
            <form className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-[#ff4500] hover:bg-[#e63e00] text-white px-6 py-3 rounded-lg font-semibold transition-colors"
              >
                Send Message
              </button>
            </form>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">support@elecart.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">123 Electronics Street<br />Tech City, TC 12345</p>
                  </div>
                </div>
              </div>
            </div>
