...
const ManageBrand = () => {
    ...
    const confirmAdd = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        // Append the file from fileInputRef
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full">
                            <thead className="bg-gray-800 transition-colors">
                                <tr>
                                    <th className="px-6 py-4 text-left">Brand Logo</th>
                                    <th className="px-6 py-4 text-left">Brand Name</th>
                                    <th className="px-6 py-4 text-left">Brand Description</th>
                                ...
                                {allBrands && allBrands.map((brand: Brand) => (
                                    ...
                                    >
                                        <td className="px-6 py-4">
                                            <img src={brand.logo} alt={brand.name} className="w-10 h-10 object-cover rounded" />
                                        </td>
                        ...
                        >
                            ...
                            <form onSubmit={confirmAdd}>
                                <div className="mb-4">
                                    ...
                                    <input type="text" id="name" name="name" required className="w-full px-3 py-2 bg-gray-700 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" />
                                </div>
                                <div className="mb-4">
                                    <label htmlFor="description" className="block text-sm font-medium text-gray-300 mb-2">Description</label>
                                    <textarea id="description" name="description" required className="w-full px-3 py-2 bg-gray-700 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"></textarea>
                                </div>
                                <div className="mb-4">
                                    <label htmlFor="logo" className="block text-sm font-medium text-gray-300 mb-2">Logo</label>
                                    <input 
                                        type="file" 
                                        id="logo" 
                                        name="file" 
                                ...
                                {previewImage && (
                                    <div className="mb-4">
                                        <Image src={previewImage} alt="Preview" width={100} height={100} className="rounded-md" />
                                    </div>
                                )}
                                <div className="flex justify-end gap-4">
                                    <button
